...
dataName = 'run28_3px_1508\'; % name to identify the particular set of data collected in a particular run
...
maxAngle = 5.5; % maximum angle the razor will tilt to
...
checkerboardToUse = "3.png"; % filename of checkerboard to use in this run
filetype = ".png";
