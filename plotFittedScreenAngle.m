...
dataName = 'run10_3px_focussed\'; % name to identify the particular set of data collected in a particular run
...
title("fitted rotation about x and y axes against angle of razor blade");
