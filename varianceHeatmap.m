...
imgfolder = "C:\Users\Christopher\Documents\NatSci\Year 4\Project\MATLAB\CapturedImages\run1\images\4_2\";
...
fracheights = stdheights./abs(meanheights+min(meanheights,[],"all"));
s=size(fracheights);
